        ...
        do{
            ...
            switch(scelta){
                ...
                case 4:
                        ...
                        y=(int)(Math.random()*200-100);
                        p3=new Puntoo(x,y);
                        System.out.println("Coordinate dei vertici del triangolo:");
                        System.out.println("A("+p1.getX()+","+p1.getY()+"), B("+p2.getX()+","+p2.getY()+"), C("+p3.getX()+","+p3.getY()+")"); 
                        tri=new Triangolo(p1,p2,p3);
                        System.out.println("Il perimetro del triangolo è: "+tri.perimetro());
                        break;
